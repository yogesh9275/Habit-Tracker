<x-layouts.app :title="'Edit Habit'">
    <div class="max-w-2xl mx-auto">
        <h1 class="text-xl font-bold mb-4">Edit Habit</h1>
        ...
        <form wire:submit.prevent="update" class="space-y-4">
            ...
            <div>
                <label class="block font-medium">Days of Week</label>
            ...
            <button class="px-4 py-2 bg-blue-600 text-white rounded">Update Habit</button>
        </form>
    </div>
</x-layouts.app>
